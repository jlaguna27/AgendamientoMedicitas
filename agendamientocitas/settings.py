"""
Django settings for agendamientocitas project.
...
SECRET_KEY = 'hw9rkn(yqe!7*9514oo9y5ubd6oz0x!1vvy^4dvg-cy_2p2%(w'
...
WSGI_APPLICATION = 'agendamientocitas.wsgi.application'
